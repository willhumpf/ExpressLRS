...
const fhss_config_t domains[] = {
    ...
    {"RT800",  FREQ_HZ_TO_REG_VAL(790000000), FREQ_HZ_TO_REG_VAL(810000000), 40},
    {"RT800W", FREQ_HZ_TO_REG_VAL(780000000), FREQ_HZ_TO_REG_VAL(820000000), 40},
    {"RT810",  FREQ_HZ_TO_REG_VAL(800000000), FREQ_HZ_TO_REG_VAL(820000000), 40},
    {"RT810W", FREQ_HZ_TO_REG_VAL(790000000), FREQ_HZ_TO_REG_VAL(830000000), 40},
    {"RT820",  FREQ_HZ_TO_REG_VAL(810000000), FREQ_HZ_TO_REG_VAL(830000000), 40},
    {"RT820W", FREQ_HZ_TO_REG_VAL(800000000), FREQ_HZ_TO_REG_VAL(840000000), 40},
    {"RT830",  FREQ_HZ_TO_REG_VAL(820000000), FREQ_HZ_TO_REG_VAL(840000000), 40},
    {"RT830W", FREQ_HZ_TO_REG_VAL(810000000), FREQ_HZ_TO_REG_VAL(850000000), 40},
    {"RT840",  FREQ_HZ_TO_REG_VAL(830000000), FREQ_HZ_TO_REG_VAL(850000000), 40},
    {"RT840W", FREQ_HZ_TO_REG_VAL(820000000), FREQ_HZ_TO_REG_VAL(860000000), 40},
    {"RT850",  FREQ_HZ_TO_REG_VAL(840000000), FREQ_HZ_TO_REG_VAL(860000000), 40},
    {"RT850W", FREQ_HZ_TO_REG_VAL(830000000), FREQ_HZ_TO_REG_VAL(870000000), 40},
    {"RT860",  FREQ_HZ_TO_REG_VAL(850000000), FREQ_HZ_TO_REG_VAL(870000000), 40},
    {"RT860W", FREQ_HZ_TO_REG_VAL(840000000), FREQ_HZ_TO_REG_VAL(880000000), 40},
    {"RT870",  FREQ_HZ_TO_REG_VAL(860000000), FREQ_HZ_TO_REG_VAL(880000000), 40},
    {"RT870W", FREQ_HZ_TO_REG_VAL(850000000), FREQ_HZ_TO_REG_VAL(890000000), 40},
    {"RT880",  FREQ_HZ_TO_REG_VAL(870000000), FREQ_HZ_TO_REG_VAL(890000000), 40},
    {"RT880W", FREQ_HZ_TO_REG_VAL(860000000), FREQ_HZ_TO_REG_VAL(900000000), 40},
    {"RT890",  FREQ_HZ_TO_REG_VAL(880000000), FREQ_HZ_TO_REG_VAL(900000000), 40},
    {"RT890W", FREQ_HZ_TO_REG_VAL(870000000), FREQ_HZ_TO_REG_VAL(910000000), 40},
    {"RT900",  FREQ_HZ_TO_REG_VAL(890000000), FREQ_HZ_TO_REG_VAL(910000000), 40},
    {"RT900W", FREQ_HZ_TO_REG_VAL(880000000), FREQ_HZ_TO_REG_VAL(920000000), 40},
    {"RT910",  FREQ_HZ_TO_REG_VAL(900000000), FREQ_HZ_TO_REG_VAL(920000000), 40},
    {"RT910W", FREQ_HZ_TO_REG_VAL(890000000), FREQ_HZ_TO_REG_VAL(930000000), 40},
    {"RT920",  FREQ_HZ_TO_REG_VAL(910000000), FREQ_HZ_TO_REG_VAL(930000000), 40},
    {"RT920W", FREQ_HZ_TO_REG_VAL(900000000), FREQ_HZ_TO_REG_VAL(940000000), 40},
    {"RT930",  FREQ_HZ_TO_REG_VAL(920000000), FREQ_HZ_TO_REG_VAL(940000000), 40},
    {"RT930W", FREQ_HZ_TO_REG_VAL(910000000), FREQ_HZ_TO_REG_VAL(950000000), 40},
    {"RT940",  FREQ_HZ_TO_REG_VAL(930000000), FREQ_HZ_TO_REG_VAL(950000000), 40},
    {"RT940W", FREQ_HZ_TO_REG_VAL(920000000), FREQ_HZ_TO_REG_VAL(960000000), 40},
    {"RT950",  FREQ_HZ_TO_REG_VAL(940000000), FREQ_HZ_TO_REG_VAL(960000000), 40},
    {"RT950W", FREQ_HZ_TO_REG_VAL(930000000), FREQ_HZ_TO_REG_VAL(970000000), 40},
    {"RT960",  FREQ_HZ_TO_REG_VAL(950000000), FREQ_HZ_TO_REG_VAL(970000000), 40},
    {"RT960W", FREQ_HZ_TO_REG_VAL(940000000), FREQ_HZ_TO_REG_VAL(980000000), 40},
    {"RT970",  FREQ_HZ_TO_REG_VAL(960000000), FREQ_HZ_TO_REG_VAL(980000000), 40},
    {"RT970W", FREQ_HZ_TO_REG_VAL(950000000), FREQ_HZ_TO_REG_VAL(990000000), 40},
    {"RT980",  FREQ_HZ_TO_REG_VAL(970000000), FREQ_HZ_TO_REG_VAL(990000000), 40},
    {"RT980W", FREQ_HZ_TO_REG_VAL(960000000), FREQ_HZ_TO_REG_VAL(1000000000), 40},
    {"RT990",  FREQ_HZ_TO_REG_VAL(980000000), FREQ_HZ_TO_REG_VAL(1000000000), 40},
    {"RT990W", FREQ_HZ_TO_REG_VAL(970000000), FREQ_HZ_TO_REG_VAL(1010000000), 40},
    {"RT1G",   FREQ_HZ_TO_REG_VAL(990000000), FREQ_HZ_TO_REG_VAL(1010000000), 40},
    {"RT1GW",  FREQ_HZ_TO_REG_VAL(980000000), FREQ_HZ_TO_REG_VAL(1020000000), 40},
    {"RTWide", FREQ_HZ_TO_REG_VAL(800000000), FREQ_HZ_TO_REG_VAL(1000000000), 40},
};
