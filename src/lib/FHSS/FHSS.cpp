...
const fhss_config_t domains[] = {
    ...
    {"RT800",  FREQ_HZ_TO_REG_VAL(800000000), FREQ_HZ_TO_REG_VAL(850000000), 20},
    {"RT950",  FREQ_HZ_TO_REG_VAL(950000000), FREQ_HZ_TO_REG_VAL(100000000), 20},
    {"RT1G",  FREQ_HZ_TO_REG_VAL(990000000), FREQ_HZ_TO_REG_VAL(1010000000), 20},
    {"RT825",  FREQ_HZ_TO_REG_VAL(825000000), FREQ_HZ_TO_REG_VAL(850000000), 20},
    {"RT975",  FREQ_HZ_TO_REG_VAL(975000000), FREQ_HZ_TO_REG_VAL(1000000000), 20},
};
